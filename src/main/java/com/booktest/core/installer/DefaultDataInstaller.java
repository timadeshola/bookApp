package com.booktest.core.installer;
...
public class DefaultDataInstaller implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    public DefaultDataInstaller(UserRepository userRepository, RoleRepository roleRepository, PasswordEncoder passwordEncoder, BookRepository bookRepository, ModelMapper modelMapper, BookElasticsearchRepository elasticsearchRepository) {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        final Set<Role> reviewerRole = new HashSet<>(Collections.singletonList(reviewer));
    ...
    @Transactional
    protected void createUserIfNotFound(final String username, final String email, final String firstName, final String lastName, final String password, final String phoneNumber, final Set<Role> roles) {
    ...
    @Transactional
    protected void createBookIfNotExist(String author, String title) {
