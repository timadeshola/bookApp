...
public class BookResourceTest {
    ...
    public void createBookTest() throws Exception {
        BookResource resource = BookResource.builder().id(20L).title("ElasticsearchBook App").author("John Adeshola").build();
    ...
    public void updateBookTest() throws Exception {
        BookResource resource = BookResource.builder().id(1L).title("ElasticsearchBook App").author("John Adeshola").build();
